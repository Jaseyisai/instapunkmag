exports.handler = async function (event, context) {
  ...
  try {
    ...
    const prompt = `You are a passionate punk music critic writing for Insta Punk Mag. Write an engaging 400-500 word music feature about the following:

Artist/Topic: "${title}"
Genre: ${genre}
Angle: ${desc}

Write in a punk magazine voice — opinionated, energetic, informed. Include references to influences, similar bands, what makes this music significant right now. 
...
- listenTo: array of 3 song or album recommendations related to this topic
